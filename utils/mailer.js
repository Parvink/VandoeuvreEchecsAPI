...
async function sendInvitationMail(event, firstname, id, mail) {
  try {
    ...
    let info = await transporter.sendMail({
      ...
      text: `Bonjour ${firstname}, je t'envoie ce mail afin de t'inviter à l'évènement ${event.name} qui aura lieu le ${eventDate.toLocaleDateString("fr-FR")}.
      Je t'invite à te rendre sur ce lien afin de confirmer ou refuser l'invitation: http://vandoeuvre-echecs/invitations/${event.id}/${id}/
